...
START TRANSACTION;
USE `c#_exam`;
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (1, 'Dagmara', 'Przygocka', 'dagmara', 'tigerISmyDOG', 1, 1, 1, 1, 1);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (2, 'Aleksandar', 'Minchev', 'alex', 'IwantAnewJOB', 2, 2, 2, 2, 2);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (3, 'Dorin', 'Moldovan', 'dorin', 'IMissTheNetherlands', 3, 3, 3, 3, 3);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (4, 'Alexandru', 'Gabriel', 'gabriel', 'notEnoughSleep', 4, 4, 4, 4, 4);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (5, 'Janus', 'Pedersen', 'janus', 'password', 5, 5, 5, 5, 5);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (6, 'Brad', 'Pitt', 'brad', 'password', 6, 6, 6, 6, 6);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (7, 'Antonio', 'Banderas', 'antonio', 'password', 7, 7, 7, 7, 7);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (8, 'Michael', 'Schumacher', 'michael', 'password', 8, 8, 8, 8, 8);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (9, 'Niels', 'Bohr', 'niels', 'password', 9, 9, 9, 9, 9);
INSERT INTO `c#_exam`.`user` (`user_id`, `first_name`, `second_name`, `username`, `password`, `reading_id`,  `contact_id`, `address_id`, `bank_id`, `house_id`)
	VALUES (10, 'Nikola', 'Tesla', 'nikola', 'password', 10, 10, 10, 10, 10);
COMMIT;
...
START TRANSACTION;
USE `c#_exam`;
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(1, 89896767, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(2, 89896754, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(3, 89896765, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(4, 89896725, 'Nordea');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(5, 89896766, 'Jyske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(6, 89896345, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(7, 89896876, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(8, 89896090, 'Jyske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(9, 89896088, 'Danske Bank');
INSERT INTO `c#_exam`.`user_bank` (`bank_id`, `account_no`, `bank_name`)
	VALUES(10, 89896555, 'Nordea');
COMMIT;
